...
Install_Bt(){
	...
	wget -O panel.zip https://raw.iqiq.io/jellyfina/btpanel-v7.7.0/main/install/src/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://raw.iqiq.io/jellyfina/btpanel-v7.7.0/main/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://raw.iqiq.io/jellyfina/btpanel-v7.7.0/main/install/src/bt7.init -T 10
